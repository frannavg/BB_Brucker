...
static int LowerBoundCalc(machine_nr, num_of_pred, local_head, Op)	int machine_nr;  int num_of_pred[];  int local_head[];  int Op;
...
static struct List  *OutputList[MaxNumOfMachines];
